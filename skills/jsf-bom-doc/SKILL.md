...
| 方式 | 适用场景 | GAV | 详见 |
|------|---------|-----|------|
| 继承 jsf-parent | 启动项目（推荐） | `io.soil.jsf:jsf-parent:0.0.1` | [jsf-parent.md](references/jsf-parent.md) |
| 继承 jsf-dependencies | 非启动项目 | `io.soil.jsf:jsf-dependencies:0.0.1` | [jsf-dependencies.md](references/jsf-dependencies.md) |
| 导入 jsf-dependencies BOM | 非启动项目（已有父 POM） | `io.soil.jsf:jsf-dependencies:0.0.1` | [jsf-dependencies.md](references/jsf-dependencies.md) |
