# WsfHttpExceptionResponse

> WSF 异常响应内容，用于封装异常信息返回给客户端
...
`static WsfHttpExceptionResponse createFrom(Throwable ex)`
...
**返回**: `WsfHttpExceptionResponse` — 异常响应 VO
...
```java
WsfHttpExceptionResponse response = WsfHttpExceptionResponse.createFrom(exception);
